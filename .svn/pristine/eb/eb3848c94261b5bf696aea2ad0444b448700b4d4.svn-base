...
#define APP_ID          @"wxb15e39e41e14ee6e"               //APPID
#define APP_SECRET      @"68c4801ebe385322b559a2c8abbd0dcc" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1234161701"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"61d2671a3bd460b46daa8bd3ee0188e7"
//支付结果回调页面
...
@property(nonatomic, retain) NSString *order_name;
