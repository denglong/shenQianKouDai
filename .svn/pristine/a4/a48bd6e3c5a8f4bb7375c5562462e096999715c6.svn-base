...
-(void)updateShoppingCart{
    ...
    if ([[cartModel goodsNum] intValue] >= 10 && [[cartModel goodsNum] intValue] < 100) {
        self.redWidthConstraint.constant = 23;
    }
    else if ([[cartModel goodsNum] intValue] >= 100 && [[cartModel goodsNum] intValue] < 1000) {
        self.redWidthConstraint.constant = 30;
    }
    else if ([[cartModel goodsNum] intValue] >= 1000) {
        self.redWidthConstraint.constant = 40;
    }
    else
    {
        self.redWidthConstraint.constant = 18;
    }
